...
export async function POST(req: Request) {
  try {
    ...
    if (!sponsorId?.trim()) errors.sponsorId = "Sponsor ID is required.";
    if (!sponsorName?.trim()) errors.sponsorName = "Sponsor name is required.";
    if (!placement) errors.placement = "Please select placement (Left/Right).";
    ...
    if (!nomineeDob) errors.nomineeDob = "Nominee date of birth is required.";
        ...
        <div style="font-family:sans-serif;max-width:680px;margin:0 auto;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:32px;background:#fff;">
            <table style="width:100%;border-collapse:collapse;">
              ...
              ${section("Sponsor & Network")}
              ${row("Sponsor ID", sponsorId)}
              ${row("Sponsor Name", sponsorName)}
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:32px;background:#fff;color:#374151;line-height:1.7;">
            ...
            <p style="margin:0 0 28px;color:#6b7280;font-size:14px;">Once approved, you will receive your Distributor ID and login credentials via this email.</p>

...
import ZeroInvestmentBadge from "./Zeroinvestmentbadge";

const HIGHLIGHTS = [
  {
    icon: ShoppingBag,
    label: "Shop Daily Essentials",
    description: "Groceries, Fashion & More",
  },
  {
    icon: Users,
  ...
  {
    icon: TrendingUp,
    label: "Earn Automatically",
    description: "From Every Purchase",
  },
  {
    icon: Shield,
    label: "Zero Investment",
    description: "No Risk, No Capital",
  },
];
...
export default function HeroSection() {
  ...
  <span className="text-foreground">Turn Your Everyday </span>
